...
KPI_DEFS = [
    ...
    },
    {
        ...
        "baseline": 90.0,
        "target": 95.0,
        "description": "SHMOO ML parent KPI — 5-fold CV accuracy from VDD × Frequency boundary extraction.",
        "accent": "#A78BFA",
    },
    {
        "key": "shmoo_yield_analysis",
        ...
        "baseline": 80.0,
        "target": 90.0,
        "description": "Shmoo pass-rate across VDD/Frequency points from the latest ML run.",
        "accent": "#C4B5FD",
    },
    {
        "key": "shmoo_debugging",
        ...
        "baseline": 20.0,
        "target": 10.0,
        "description": "Shmoo fail-rate across test points — lower is better for debug health.",
        "accent": "#8B5CF6",
    },
    {
        "key": "shmoo_binning",
        ...
        "baseline": 60.0,
        "target": 75.0,
        "description": "High-bin / strong-silicon share from Shmoo multi-device ranking (pass-rate proxy until full binning API).",
        "accent": "#7C3AED",
    },
    {
        "key": "shmoo_characterization",
        ...
        "baseline": 85.0,
        "target": 90.0,
        "description": "RANSAC boundary fit quality (R² × 100) for VDD/Frequency characterization.",
        "accent": "#6D28D9",
    },
]
