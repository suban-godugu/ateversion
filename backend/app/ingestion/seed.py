...
KPI_DEFS = [
    ...
    # Hidden metrics — values shown inside the SHMOO parent card only (not separate grid cards)
    {
        ...
        "baseline": 80.0,
        "target": 90.0,
        "description": "Shmoo pass-rate (embedded in SHMOO ML-Based Optimization card).",
        "accent": "#C4B5FD",
    },
    {
        "key": "shmoo_debugging",
        ...
        "baseline": 20.0,
        "target": 10.0,
        "description": "Shmoo fail-rate (embedded in SHMOO ML-Based Optimization card).",
        "accent": "#8B5CF6",
    },
    {
        "key": "shmoo_binning",
        ...
        "baseline": 60.0,
        "target": 75.0,
        "description": "High-bin share proxy (embedded in SHMOO ML-Based Optimization card).",
        "accent": "#7C3AED",
    },
    {
        ...
        "baseline": 85.0,
        "target": 90.0,
        "description": "Boundary R² × 100 (embedded in SHMOO ML-Based Optimization card).",
        "accent": "#6D28D9",
    },
]
